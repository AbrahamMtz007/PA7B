...
public class OfficesDaoImpl implements OfficesDao{
    ...
    public String updateOffice(OfficesModel newOffice) {
        ...
        try {
            ...
            preparedStatement.setString(1, newOffice.getCity());        
            preparedStatement.setString(2, newOffice.getPhone());
            preparedStatement.setString(3, newOffice.getAddressLine1());
            preparedStatement.setString(4, newOffice.getAddressLine2());
            preparedStatement.setString(5, newOffice.getState());
            preparedStatement.setString(6, newOffice.getCountry());
            preparedStatement.setString(7, newOffice.getPostalCode());
            preparedStatement.setString(8, newOffice.getTerritory());
            preparedStatement.setString(9, newOffice.getOfficeCode());
